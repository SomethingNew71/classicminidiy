...
Below you will find a (relatively) comprehensive list to the parts and things you may need to accomplish this on your own car. If you are keen to do this to your car, start here as we we go through the various aspects of a conversion like this. Strap in and get ready. Its time to learn about EFI and the Classic Mini.
...
The final component to complete all of the sensors your ECU will need to understand the state of the car, is a Wideband O2 Sensor. These are also called Air Fuel Ratio gauges, or AFR sensors. This sensor is sniffing the exhaust as it exits the car and measuring the amount of fuel present in that air. This creates a lambda value or a ratio percentage your ECU will use to adjust the amount of fuel it should be firing into the intake.
