  ...
  <div class="h-full">
    ...
    <div v-if="!currentArtifact" class="flex h-full items-center justify-center">
      <div class="text-center">
        <Icon name="mdi:code-braces" class="mx-auto h-16 w-16 text-base-content/30" />
    ...
    <div v-else class="flex h-full flex-col">
        ...
        <div class="flex items-start justify-between">
          ...
          <div class="flex items-center gap-1">
            ...
            <button @click="copyArtifact" class="btn btn-ghost btn-sm btn-square" title="Copy to clipboard">
              <Icon :name="copySuccess ? 'mdi:check' : 'mdi:content-copy'" class="h-4 w-4" />
            </button>
      ...
      <div class="flex-1 overflow-hidden">
        ...
        <div v-else class="flex h-full items-center justify-center">
          <div class="text-center">
            <Icon name="mdi:file-question" class="mx-auto h-12 w-12 text-base-content/40" />
