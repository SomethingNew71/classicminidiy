<template>
  <div class="chasis">
    <div class="screen">
      <div class="header">
        <div class="brand">
          <img src="https://classicminidiy.s3.amazonaws.com/misc/avatar.png" alt="">
      ...
      <div class="content">
        <div class="item first">
          ...
          <div class="text">
            <div class="heading">
              Fred <span>yesterday</span>
            </div>
            <div class="line">
              How do I set the timing on my classic mini?
            </div>
          </div>
        </div>
        <div class="item">
        ...
        <div class="item">
          ...
          <div class="text">
            <div class="heading">
              Cole <span>Today</span>
            </div>
            <div class="line">
              It's a simple thing.
            </div>
            <div class="line">
              Check out this guide I made on my channel.
            </div>
          </div>
        </div>
        <div class="item">
        ...
        <div class="item">
          ...
          <div class="text">
            <div class="heading">
              William <span>Tomorrow</span>
            </div>
            <div class="line">
              Looks like Cole isn't online right not but this is actually something I have done before on my car.
            </div>
            <div class="line">
              The best way to get it working is to just make it work from the beginning.
            </div>
          </div>
        </div>
      </div>
...
.chasis {
  ...
  .screen {
    ...
    .header {
      width: 100%;
      height: 50px;
      font-family: discord-bold, sans-serif;
      background: #202225;
      display: flex;
      color: $white;
      z-index: 5;
