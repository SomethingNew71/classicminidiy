  ...
  <div>
    ...
    >
      <form action="">
        ...
        <div
          v-if="!processing && !questionSent && !apiError"
          class="modal-card"
        >
          <header class="modal-card-head">
            <h1 class="modal-card-title">Ask a Question!</h1>
            <button
              type="button"
              class="delete"
          ...
          <section class="modal-card-body">
            <p class="pb-5">
              Classic Mini DIY has always been about making things easier for
              everyone! If you have a technical question you would like to ask
              me, fill out the details below and I will get back to you within
              approx 5 days or less!
            </p>
            <b-field label="Email">
        ...
        <div v-if="!processing && questionSent && !apiError" class="modal-card">
          <div class="modal-card-body has-text-centered pt-5">
            ...
            <h2 class="is-size-5 pb-4">Your question has been submitted</h2>
            <p class="is-size-6">
              Please allow me a few days to get back to you.
            </p>
            <b-button
              label="Close"
              @click="(isComponentModalActive = false), (questionSent = false)"
            />
          </div>
        </div>
        <div v-if="!processing && !questionSent && apiError" class="modal-card">
          <div class="modal-card-body has-text-centered pt-5">
            ...
            <h2 class="is-size-6 pb-4">
              There was a problem submitting your question at this time, please
              try again later!
            </h2>
            <b-button label="Close" @click="isComponentModalActive = false" />
            <b-button
