    ...
    <template v-if="size === 'large'">
      <div class="columns">
        ...
        <div class="column is-9">
          <h3 class="fancy-font-book-oblique is-size-5"><i class="fad fa-hands-heart"></i> SUPPORT THE SITE</h3>
    ...
    <template v-if="size === 'small'">
      <div class="columns is-multiline">
        <div class="column is-12">
          <h3 class="fancy-font-book-oblique is-size-5 pt-2"><i class="fad fa-hands-heart"></i> SUPPORT THE SITE</h3>
        </div>
        <div class="column is-12">
          <p class="is-size-6">
            Classic Mini DIY is
